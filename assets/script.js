$(document).ready(function () {
	...
	// Création du hover sur les murs
	$('.murver').hover(function(){
		$(this).addClass('murhover');
		}, function(){
		$(this).removeClass('murhover');
	});

	$('.murhor').hover(function(){
		$(this).addClass('murhover');
		}, function(){
		$(this).removeClass('murhover');
	});

	// Création de la fonction actif et comptage des murs
	var counteurmur = 0;

		$('.murver').on('click', function () {
			$(this).addClass('muractif');
			counteurmur++;
		});
		$('.murhor').on('click', function () {
			$(this).addClass('muractif');
			counteurmur++;
		});

	// Calcule des emplacements voisins
